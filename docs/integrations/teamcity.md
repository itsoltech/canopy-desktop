...
| `CiConfigUnwritable` | A local filesystem failure while writing `.canopy/config.json` (permissions, disk, a transient read error on an existing file)                                                                                                                                                                                                               | The configurator's footer live region — never with the `TeamCity:` prefix, because nothing in the save chain talks to the server                                                                                                                                                                                                               |
