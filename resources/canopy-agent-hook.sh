...
# Stream the body from stdin, never argv: Linux caps one execve argument at
# 128 KiB, and Claude Code 2.1.261's bashOutputMaxChars/taskOutputMaxChars let a
# PostToolUse tool_response reach that size. Matches canopy-agent-hook.cmd.
