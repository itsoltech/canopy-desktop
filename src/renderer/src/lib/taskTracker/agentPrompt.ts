...
5. \`projectOverrides\` are keyed by the tracker project key — the task-key prefix (\`GAKKO-1\` → \`GAKKO\`) — and take precedence over the root templates for tasks from that project.
