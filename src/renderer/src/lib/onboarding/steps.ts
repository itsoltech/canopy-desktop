...
export const onboardingSteps: OnboardingStep[] = [
  ...
  },
  {
    ...
    description:
      'Mirror and control this Canopy window from the mobile app on the same WiFi. Enable it in Settings → Remote Control, select the reachable network adapter, then use the REMOTE section in the left sidebar to scan a QR code and pair a device. Beta — expect rough edges while we iterate.',
    introducedIn: '0.10.0',
    category: 'feature',
  },
  {
  ...
  },
  {
    ...
    description:
      'The Tools section in Settings now lets you reorder tools and hide the ones you rarely launch. Use the up/down arrows to reorder and the eye toggle to hide a tool from the sidebar — hidden tools stay searchable in the command palette. AI agents and custom CLI tools share one list, so you can sort them freely.',
    introducedIn: '0.13.0',
    category: 'feature',
  },
]
