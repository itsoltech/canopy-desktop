...
export const onboardingSteps: OnboardingStep[] = [
  ...
  },
  {
    ...
    description:
      'Mirror and control this Canopy window from your phone, tablet, or another laptop on the same WiFi. Enable it in Settings → Remote Control, select the reachable network adapter, then use the REMOTE section in the left sidebar to scan a QR code and pair a device. Beta — expect rough edges while we iterate.',
    introducedIn: '0.10.0',
    category: 'feature',
  },
  {
