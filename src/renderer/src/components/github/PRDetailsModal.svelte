<script lang="ts">
  ...
  // reviewDecision is typed `string | null` from the GitHub API, so `.otherwise`
  // rather than `.exhaustive` — mirrors github.svelte.ts, which already models
  // this same branching with ts-pattern.
